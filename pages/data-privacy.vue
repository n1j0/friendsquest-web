...
<template>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <h2 class="text-2xl font-medium my-6">Interpretation and Definitions</h2>
        <h3 class="text-xl font-medium my-4">Interpretation</h3>
        ...
        <h3 class="text-xl font-medium my-4">Definitions</h3>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to FriendsQuest, the software program provided by the
                    Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                    Agreement) refers to FriendsQuest.</p>
            ...
            <li>
                <p><strong>You</strong> means the individual accessing or using the Service, or the company, or
                    ...
                    applicable.</p>
                <p>Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject or as
                    the User as you are the individual using the Service.</p>
            </li>
        </ul>
        <h2 class="text-2xl font-medium my-6">Collecting and Using Your Personal Data</h2>
        <h3 class="text-xl font-medium my-4">Types of Data Collected</h3>
        <h4 class="text-lg font-medium my-2">Personal Data</h4>
        ...
        <h4 class="text-lg font-medium my-2">Usage Data</h4>
        ...
        <p>The app does use third-party services that may collect information used to identify you. Links to the privacy policy of third-party service providers used by the app:</p>
        <ul>
            <li>
                Google Firebase Authentication: Is used to create and manage user accounts. We collect a user's password and email address for authentication purposes. See the following page:
                <a href="https://firebase.google.com/support/privacy/">Firebase Privacy Policy</a>
            </li>
            <li>Sentry: Is used to log errors that occur whilst using the app. The privacy policy can be found at <a href="https://sentry.io/privacy">Sentry Privacy Policy</a>.</li>
        </ul>
        <h4 class="text-lg font-medium my-2">Information Collected while Using the Application</h4>
        ...
        <h3 class="text-xl font-medium my-4">Use of Your Personal Data</h3>
        ...
        <h3 class="text-xl font-medium my-4">Retention of Your Personal Data</h3>
        ...
        <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
            ...
            periods.</p>
        <h3 class="text-xl font-medium my-4">Transfer of Your Personal Data</h3>
        ...
        <h3 class="text-xl font-medium my-4">Delete Your Personal Data</h3>
        ...
        <h3 class="text-xl font-medium my-4">Disclosure of Your Personal Data</h3>
        <h4 class="text-lg font-medium my-2">Business Transactions</h4>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred.
            ...
            Privacy Policy.</p>
        <h4 class="text-lg font-medium my-2">Law enforcement</h4>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do
            ...
            agency).</p>
        <h4 class="text-lg font-medium my-2">Other legal requirements</h4>
        ...
        <h3 class="text-xl font-medium my-4">Security of Your Personal Data</h3>
        ...
        <h2 class="text-2xl font-medium my-6">GDPR Privacy</h2>
        <h3 class="text-xl font-medium my-4">Legal Basis for Processing Personal Data under GDPR</h3>
        ...
        <h3 class="text-xl font-medium my-4">Your Rights under the GDPR</h3>
        ...
        <h3 class="text-xl font-medium my-4">Exercising of Your GDPR Data Protection Rights</h3>
        ...
        <h2 class="text-2xl font-medium my-6">Children's Privacy</h2>
        ...
        <p>If We need to rely on consent as a legal basis for processing Your information and Your country requires
            ...
            information.</p>
        <h2 class="text-2xl font-medium my-6">Links to Other Websites</h2>
        ...
        <h2 class="text-2xl font-medium my-6">Changes to this Privacy Policy</h2>
        ...
        <h2 class="text-2xl font-medium my-6">Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
            <li>By email: app.friendsquest@gmail.com</li>
        </ul>
    </div>
</template>
